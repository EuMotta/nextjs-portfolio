        ...
        {AboutSection.map((about) => (
          ...
          >
            <motion.p
              ...
              className={`${styles.xPaddings} mt-2 gap-x-2 flex font-normal text-center text-secoundary-white`}
            >
              <span className="w-2/4 md:text-xl grid sm:text-md font-extrabold text-slate-900 dark:text-white">
                {about.title}
              </span>
