          ...
          <div className=" rounded-lg p-10">
            <span className="text-center my-2">
              <TypingText
                ...
                textStyles="sm:text-center sm:text-xl md:text-2xl md:text-center lg:text-3xl text-slate-900 font-bold my-10 "
              />
            </span>
            <form className=" rounded-xl flex justify-center text-xl p-5">
              <div className="rounded-xl flex items-center">
                ...
                />
                <button className="text-slate-900  px-1" type="button" onClick={checkCNPJ}>
